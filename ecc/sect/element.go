...
const qInvNeg = 11714297528646643681

// mu = 2^288 / q needed for partial Barrett reduction
const mu uint64 = 144115188075855871
...
var errInvalidEncoding = errors.New("invalid sect.Element encoding")
