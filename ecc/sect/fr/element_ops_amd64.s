...
// modulus q
DATA q<>+0(SB)/8, $0x6efb1ad5f173abdf
DATA q<>+8(SB)/8, $0x00069d5bb915bcd4
DATA q<>+16(SB)/8, $0
DATA q<>+24(SB)/8, $0x0000008000000000
GLOBL q<>(SB), (RODATA+NOPTR), $32

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xa2918b898c382fe1
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    16(DX), R10
	SBBQ    24(DX), R11
	MOVQ    $0x6efb1ad5f173abdf, R12
	MOVQ    $0x00069d5bb915bcd4, R13
	MOVQ    $0, R14
	MOVQ    $0x0000008000000000, R15
	CMOVQCC AX, R12
	CMOVQCC AX, R13
	CMOVQCC AX, R14
	CMOVQCC AX, R15
